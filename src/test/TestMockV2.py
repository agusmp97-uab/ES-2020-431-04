...
class TestMockV2:
    ...
    def test_payment_method(self, monkeypatch, journey_multiple_passengers, user, payment_data_type):
    ...
    def test_do_payment_fail(self, monkeypatch, journey_multiple_passengers, user, payment_data_type):
        def mock_return(self, user, payment_data):
            return False
    ...
    def test_do_reserve_fail(self, monkeypatch, journey_multiple_passengers, user, payment_data_type):
